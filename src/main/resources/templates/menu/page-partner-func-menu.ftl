 <!-- 合作伙伴相关功能底部主菜单--> 
  ...
  <div class="weui-tabbar" style="position:fixed;left:0px;bottom:0px">
	...
	<#if ((myPartner.pbTp)!'')=='1' && (partnerUserTP=='bindVip' || (partnerUserTP=='staff' && ((partnerStaff.tagList)!'')?contains('goods')) )>
	...
	<#if ((myPartner.pbTp)!'')=='1' && (partnerUserTP=='bindVip' || (partnerUserTP=='staff' && ((partnerStaff.tagList)!'')?contains('postage')) )>
	...
	<#if ((myPartner.pbTp)!'')=='1' && (partnerUserTP=='bindVip' || (partnerUserTP=='staff' && ((partnerStaff.tagList)!'')?contains('pimage')) )>
	...
	<#if ((myPartner.pbTp)!'')=='1' && (partnerUserTP=='bindVip' || (partnerUserTP=='staff' && ((partnerStaff.tagList)!'')?contains('saleorder')) )>
	...
	<#if ((myPartner.pbTp)!'')=='1' && (partnerUserTP=='bindVip' || (partnerUserTP=='staff' && ((partnerStaff.tagList)!'')?contains('aftersale')) )>
