...
<!-- 消息提示模态框（Modal） -->
<div id="alertMsgModal" class="weui-loadmore" style="position:fixed;left:0;top:0;right:0;bottom:0;margin:0;width:100%;display:none;z-index:100000000;background:rgba(0,0,0,0.2);display:none;">
